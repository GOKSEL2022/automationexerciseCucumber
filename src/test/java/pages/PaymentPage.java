...
public class PaymentPage {
    ...
    public WebElement boxNameOnCard;
    @FindBy(xpath = "//*[@name='card_number']")
    public WebElement boxCardNumber;
    @FindBy(xpath = "//*[@name='cvc']")
    public WebElement boxCVC;
    @FindBy(xpath = "//*[@name='expiry_month']")
    public WebElement boxExpirationMonth;
    @FindBy(xpath = "//*[@name='expiry_year']")
    public WebElement boxExpirationYear;
    @FindBy(xpath = "//*[@id='submit']")
    public WebElement buttonPayAndConfirmOrder;

    @FindBy(xpath = "//div[normalize-space(text()) = 'Your order has been placed successfully!']")
