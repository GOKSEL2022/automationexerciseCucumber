...
public class AllProductsPage {
    ...
    public WebElement firstProductPicture;
    @FindBy(xpath = "//*[@src='/get_product_picture/2']")
    public WebElement twoProductPicture;



    //18
    @FindBy(xpath = "//a[@href='/category_products/2']")
    public WebElement buttonWomenTopsProduct;
    @FindBy(xpath = "//h2[@class='title text-center']")
    public WebElement textWomenTopProducts;
    @FindBy(xpath = "//a[@href='#Men']")
    public WebElement buttonMenProduct;
    @FindBy(xpath = "//a[@href='/category_products/3']")
    public WebElement buttonMenTshırtsProduct;
    @FindBy(xpath = "//h2[@class='title text-center']")
    public WebElement textMenTshirtsProducts;


    //19

    @FindBy(xpath = "//h2[.='Brands']")
    public WebElement textBransdProducts;
    @FindBy(xpath = "//a[@href='/brand_products/Polo']")
    public WebElement buttonBrandProductsPolo;
    @FindBy(xpath = "//h2[@class='title text-center']")
    public WebElement textBrandPoloProducts;
    @FindBy(xpath = "//a[@href='/brand_products/H&M']")
    public WebElement buttonBrandProductsHM;
    @FindBy(xpath = "//h2[@class='title text-center']")
    public WebElement textBrandHMProducts;

    //20
    @FindBy(xpath = "(//a[@data-product-id='30'])[1]")
    public WebElement buttonAddToCartProduct;
    @FindBy(xpath = "(//a[@href='/view_cart'])[2]")
    public WebElement buttonViewCartProduct;
    @FindBy(xpath = "(//a[@href='/view_cart'])[1]")
    public WebElement buttonCartProduct;
    @FindBy(xpath = "//a[@href='/product_details/30']")
    public WebElement textPremiumPoloTShirtsProduct;

    //21
    @FindBy(xpath = "//a[@href='#reviews']")
    public WebElement textWriteYourReviewProduct;
    @FindBy(id = "name")
    public  WebElement boxYourNameProduct;
    @FindBy(id = "email")
    public  WebElement boxEmailAddressProduct;
    @FindBy(id = "review")
    public  WebElement boxAddReviewHereProduct;
    @FindBy(id = "button-review")
    public  WebElement buttonSubmitReviewProduct;
